...
export default function HomePage() {
  ...
  return (
   ...
   <section className="mx-auto flex min-h-screen max-w-7xl items-center px-6 py-24 sm:px-8 sm:py-28 lg:px-10">
  <div className="mx-auto max-w-3xl text-center">
    ...
    <p className="mb-5 text-xs font-semibold uppercase tracking-[0.28em] text-emerald-700 sm:text-sm">
      AI-powered document workspace
    </p>

    <h1 className="text-4xl font-semibold tracking-[-0.04em] text-gray-900 sm:text-5xl lg:text-6xl">
      Ask your documents.
      <br />
    ...
    <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
      <Link
        href="/login"
        className="rounded-xl bg-gray-900 px-7 py-3 text-base font-medium text-white shadow-lg transition-all duration-200 hover:-translate-y-0.5 hover:bg-black hover:shadow-xl"
      >
        Get Started
      </Link>
  ...
  className="rounded-xl border border-gray-200 bg-white px-7 py-3 text-base font-medium text-gray-700 transition-all duration-200 hover:border-gray-300 hover:bg-gray-50"
>
  Learn More
</button>
    </div>
